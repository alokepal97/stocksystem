    ...
    public partial class sales : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                sql = "SELECT or_no, or_date, ref_no, ref_date, d_date, c_name, net_amount, notes FROM main_sales WHERE or_date BETWEEN '" + dateTimePicker1.Text + "' AND '" + dateTimePicker2.Text + "'";
                ...
                xlWorkSheet.Cells[1, 7] = "Net Amount";
                xlWorkSheet.Cells[1, 8] = "Notes";
                ...
                xlWorkBook.SaveAs("Sales Report.xls", Exce.XlFileFormat.xlWorkbookNormal, misValue, misValue, misValue, misValue, Exce.XlSaveAsAccessMode.xlExclusive, misValue, misValue, misValue, misValue, misValue);
                ...
                MessageBox.Show("Excel file created , you can find the file C:\\Users\\User\\Documents. Sales Report.xls");
            }
            catch (Exception u)
            {
                MessageBox.Show("" + u);
