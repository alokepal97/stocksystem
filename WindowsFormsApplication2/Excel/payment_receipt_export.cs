...
{
    public partial class payment_receipt_export : Form
    {
        private OleDbConnection connection = new OleDbConnection();
        public payment_receipt_export()
        {
            InitializeComponent();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                connection.Open();
                sql = "SELECT re_no, re_date, c_name, payment_type, invoice_type, payment_mode, ref_no, ref_date, in_no, in_date, total_amount, due_amount, receive_amount, notes, total_receive FROM payment_receipt WHERE re_date BETWEEN '" + dateTimePicker1.Text + "' AND '" + dateTimePicker2.Text + "'";
                ...
                xlWorkBook.SaveAs("Payment Receipt Details Report.xls", Exce.XlFileFormat.xlWorkbookNormal, misValue, misValue, misValue, misValue, Exce.XlSaveAsAccessMode.xlExclusive, misValue, misValue, misValue, misValue, misValue);
                ...
                MessageBox.Show("Excel file created , you can find the file C:\\Users\\User\\Documents. Payment Receipt Details Report.xls");
            }
            catch (Exception)
            {
