...
{
    public partial class tax_main : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                connection.Open();
                sql = "SELECT in_no, in_date, or_no, or_date, c_name, amount, status, due_amount FROM tax_main WHERE in_date BETWEEN '" + dateTimePicker1.Text + "' AND '" + dateTimePicker2.Text + "' AND (type = 'tax')";
                ...
                xlWorkBook.SaveAs("Tax Invoice Report.xls", Exce.XlFileFormat.xlWorkbookNormal, misValue, misValue, misValue, misValue, Exce.XlSaveAsAccessMode.xlExclusive, misValue, misValue, misValue, misValue, misValue);
                ...
                MessageBox.Show("Excel file created , you can find the file C:\\Users\\User\\Documents. Tax Invoice Report.xls");
            }
            catch (Exception)
            {
