...
{
    public partial class tax_invoice : Form
    {
        ...
        private void getid()
        {
            ...
            order.taxinvoice();
            textBox2.Text = Convert.ToString(get_id.taxinvoice_id);
           
        }

        //---------------display data into datagrid view1------------------------
        private void grid()
        {
            OleDbDataReader rdr = null;
            OleDbCommand cmd = new OleDbCommand("select * from in_main where type ='tax'", connection);
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            if (dataGridView1.Rows.Count > 0)
            {
                ...
                //!--------fetch from database
                OleDbDataReader rdr = null;
                OleDbCommand cmd = new OleDbCommand("select * from invoice where  (in_no = @id) and (type='tax')", connection);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            dataGridView2.Rows.Clear();
            textBox3.Text = "0";
             comboBox1.Text = comboBox2.Text = textBox5.Text = textBox6.Text = textBox7.Text = textBox8.Text = textBox9.Text = textBox10.Text = textBox11.Text = textBox12.Text = textBox13.Text = textBox14.Text = textBox15.Text = comboBox3.Text = textBox16.Text = textBox17.Text = textBox18.Text = textBox19.Text = textBox20.Text = null;
           // comboBox4.Text = "Cash";
        ...
        private void clear()
        {
            dataGridView2.Rows.Clear();
            textBox3.Text = "0";
            textBox2.Text = comboBox1.Text = comboBox2.Text = textBox5.Text = textBox6.Text = textBox7.Text = textBox8.Text = textBox9.Text = textBox10.Text = textBox11.Text = textBox12.Text = textBox13.Text = textBox14.Text = textBox15.Text = comboBox3.Text = textBox16.Text = textBox17.Text = textBox18.Text = textBox19.Text = textBox20.Text = null;
            //comboBox4.Text = "Cash";
            dateTimePicker1.ResetText();
            dateTimePicker2.ResetText();
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            if (dataGridView1.Rows.Count > 0)
            {
                ...
                if (cd > 0)
                {
                    ...
                    OleDbCommand cmdd = new OleDbCommand("Delete from in_main where (in_no =@item_code) and (type='tax')", connection);
                    cmdd.Parameters.AddWithValue("@item_code", row.Cells[0].Value);
                    cmdd.ExecuteNonQuery();
                    //delete from invoice
                    OleDbCommand cmd = new OleDbCommand("Delete from invoice where (in_no =@item_code)and (type='tax')", connection);
       ...
       // string id1 = "";
        ...
        private void tax_invoice_Load(object sender, EventArgs e)
        {
            getid();
        }
        ...
        {
            OleDbDataReader rdr = null;
            OleDbCommand cmd = new OleDbCommand("select * from in_main where c_name like '" + textBox1.Text + "%'", connection);
